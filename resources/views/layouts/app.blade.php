...
<body>
    <div id="app">
        <nav>
            <!-- Aquí puedes añadir tu barra de navegación -->
        </nav>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js" integrity="sha384-UO2eT0CpHqdSgQp30jms7fDyfuTcfJ8oCk0LbJO++LBomb/n5FfLGKg8f5jBBLek" crossorigin="anonymous"></script>
